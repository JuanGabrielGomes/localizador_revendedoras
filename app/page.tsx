...
export default function Home() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main id="conteudo" className="relative flex flex-1 flex-col overflow-hidden">
        <div
          aria-hidden
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-1 flex-col items-center gap-10 px-4 py-16 sm:px-6 sm:py-24">
          <div className="flex max-w-2xl flex-col items-center gap-5 text-center">
            ...
            <h1 className="max-w-xl font-serif text-3xl leading-tight text-foreground sm:text-5xl">
      ...
      <footer className="border-t border-onyx-line px-4 py-6 text-center text-xs text-foreground/60 sm:px-6">
