  ...
  return (
    <li className="flex items-start justify-between gap-3 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex gap-3">
        ...
        <div>
          <p className="font-semibold text-slate-900">{revendedora.nome}</p>
          <p className="text-sm text-slate-600">
            {revendedora.rua}, {revendedora.numero} - {revendedora.bairro},{" "}
            {revendedora.cidade}/{revendedora.estado}
          </p>
          <p className="text-sm text-slate-500">CEP {revendedora.cep}</p>
        </div>
      </div>
      <div className="flex shrink-0 flex-col items-end gap-2">
        ...
        <a
          ...
          className="whitespace-nowrap rounded-md bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-700 transition hover:bg-blue-100"
        >
          Ver rota
        </a>
      </div>
